import { CaseImageProps } from '@/modules/CaseOutlet/components/CaseImage';
import { lazy } from 'react';
import { CaseTextProps } from '../CaseText';
const CaseImage = lazy(() => import('../CaseImage'));
const CaseText = lazy(() => import('../CaseText'));

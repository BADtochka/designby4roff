...
export const routeData = {
  ...
  localization: T({
    ru: {
      caseTitle: 'COINDET',
      caseShortDescription:'Приложение, задействующее обученный искусственный интеллект, позволяющее узнать информацию и примерную стоимость своей коллекции монет.',
      caseDescription: 'Приложение, задействующее обученный искусственный интеллект, позволяющее узнать информацию и примерную стоимость своей коллекции монет.',
      ...
      textDescriptionProduct:'Приложение основано на технологии искусственного интеллекта и позволяет по фотографии определить российскую монету, её год выпуска и примерную стоимость. Проект реализован в рамках студенческой работы, где я занимался созданием интуитивной структуры взаимодействия и разработкой визуальной системы, отражающей простоту и точность продукта.',
      
      headingStructure:'СТРУКТУРА ПРИЛОЖЕНИЯ',
      textDescriptionStructure:'Пользователь выбирает одно из трёх направлений — поиск монеты, просмотр каталога или настройки. Процесс поиска разделён на простые шаги: съёмка лицевой и оборотной сторон и ввод года выпуска. Навигация выстроена последовательно и обеспечивает быстрое достижение результата.',

      headingSearchPhoto:'ПОИСК ПО ФОТО',
      textDescriptionSearchPhoto:'Основной способ определения монеты — съёмка лицевой и оборотной сторон. Приложение анализирует изображения, определяет номинал, год выпуска и примерную стоимость. Процесс занимает всего несколько секунд и не требует дополнительных действий со стороны пользователя.',

      headingCatalog:'ПОИСК В КАТАЛОГЕ',
      textDescriptionCatalog:'Функция ручного поиска позволяет находить монеты без использования камеры. Пользователь выбирает номинал, задаёт год выпуска и получает список соответствующих экземпляров с краткой информацией о каждом. Такой формат даёт возможность изучить коллекцию и быстро перейти к детальному описанию выбранной монеты.',

      headingResult:'РЕЗУЛЬТАТЫ',
      textDescriptionResult:'В ходе работы удалось выстроить простой и логичный процесс определения монеты — от съёмки до получения результата. Интерфейс оформлен так, чтобы каждая деталь поддерживала быстрые действия и не перегружала пользователя. Получившийся инструмент демонстрирует, как технологии распознавания могут работать естественно и помогать в решении повседневных задач.',
